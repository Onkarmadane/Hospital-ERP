...
function MedicineSetup() {
    ...
    return (
        <div className="w-[95%] lg:ms-[70px] bg-white mx-auto">
            {/* Header */}
            <div className="flex flex-col md:flex-row flex-wrap justify-between items-start bg-white md:items-center gap-4 md:gap-6 font-medium mb-6 border-b pb-3 sm:px-4 lg:px-6 ">
                <BackButton />
