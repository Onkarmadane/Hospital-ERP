...
//     if (newDate < workingEnd) { // Ensure start is before end
//       setWorkingStart(newDate);
//       setScrollTime(newDate); // Update scroll time to new start
//     } else {
...
//     newDate.setHours(parseInt(hours), parseInt(minutes), 0, 0);
//     if (newDate > workingStart) { // Ensure end is after start
...
//               }}
//               className="flex inline-block items-center"
//             >
...
//     setCurrentView(view);
//     if (view === 'day') {
//       setScrollTime(workingStart); // Scroll to working start time in day view
//     }
//   }, [workingStart]);

//   const handleNavigate = useCallback((date, view, action) => {
//     if (view === 'day' && action === 'TODAY') {
//       setScrollTime(workingStart); // Scroll to working start time when "today" is clicked
//     }
//   }, [workingStart]);
...
//             </p>
//             <h2 className="text-base sm:text-lg font-semibold text-gray-800 lg:text-right sm:text-right">
...
//             timeslots={calendarProps.timeslots}
//             scrollToTime={scrollTime}
//             min={workingStart} // Restrict to user-selected start time
//             max={workingEnd}   // Restrict to user-selected end time
//           />
//         </div>
//       </div>
//     </div>
