...
//       <div className="lg:sticky lg:top-0 lg:pt-2 bg-white z-[50]" >
...
//       <div className="grid grid-cols-1 gap-3  bg-white mx-auto">
//         <div>
//           {/* Card Header */}
    ...
    <div className="grid grid-cols-1 gap-3 w-[95%]  lg:ms-[70px] bg-white mx-auto max-w-7xl">
      <div className="sticky top-0 bg-white z-[20]">
        ...
        <div className="flex mb-4">
          <button onClick={() => handleTabChange('patientQueue')} className={`px-4 py-2 text-sm font-medium ${activeTab === 'patientQueue' ? 'border-b-2 border-primary text-primary' : 'text-gray-600'}`}>Patient Queue</button>
          <button onClick={() => handleTabChange('dashboardSections')} className={`px-4 py-2 text-sm font-medium ${activeTab === 'dashboardSections' ? 'border-b-2 border-primary text-primary' : 'text-gray-600'}`}>Dashboard</button>
        </div>
      </div>
      {/* Tab Content */}
