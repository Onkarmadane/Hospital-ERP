...
function Dashboard() {
  ...
  return (
    <div className="w-[95%] lg:ms-[70px] bg-white">
      ...
      {/* KPI Cards Grid */}
      <div className="flex overflow-x-auto mx-auto gap-6 mb-6">
        {/* Total Appointments */}
        <div className="bg-white p-4 rounded-lg  border border-gray-200 lg:px-[70px]">
        ...
        {/* Pending */}
        <div className="bg-white p-4 rounded-lg  border border-gray-200 px-[70px]">
