...
function NadiParikshanSection({ formData, setFormData }) {
  return (
      <div>
          <h3 className="text-lg font-semibold mb-2 text-text">Nadi Parikshan & Physical Generals</h3>
          ...
          <h3 className="text-lg font-semibold mt-4 mb-2 text-text">Physical Generals</h3>
          ...
          <input
              ...
              className="w-full p-3 border border-primary rounded-lg bg-background focus:border-primary focus:ring-2 focus:ring-primary focus:outline-none w-full mt-4"
          />
          <select
              value={formData.agni}
