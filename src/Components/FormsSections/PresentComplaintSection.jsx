  ...
  return (
    <div className='bg-background text-text'>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label htmlFor="complaint" className="block text-sm font-medium text-text">Complaint</label>
          <input
            type="text"
            id="complaint"
            name="complaint"
        ...
        <div>
          <label htmlFor="photo" className="block text-sm font-medium text-text">Photo</label>
          <input type="file" id="photo" name="photo" className="mt-1 block w-full" />
        </div>
        <div className="md:col-span-2">
          <label htmlFor="ailmentsFrom" className="block text-sm font-medium text-text">Ailments From</label>
          <input
            type="text"
            id="ailmentsFrom"
            name="ailmentsFrom"
        ...
        <div className="md:col-span-2">
          <label htmlFor="additionalComplaints" className="block text-sm font-medium text-text">Additional Complaints</label>
          <textarea
