...
const Schedule = () => {
    ...
    return (
        <div className="schedule-container text-black bg-white border border-gray-300">
            <div className="header">
                <h2 className='text-center'>HealthWell Clinic Schedule</h2>
                <div className="tabs text-right">
                    <span>Day</span>
                    <span>Week</span>
                    <span>Month</span>
                    <span>Agenda</span>
            ...
            <div className="current-time-indicator text-center text-blue-500 font-bold">
